  ...
  useEffect(() => {
    if ('serviceWorker' in navigator) {
      navigator.serviceWorker
        ...
        .then((registration) => {
          console.log('Bitcoin Music SW registered: ', registration);
            ...
            if (newWorker) {
              newWorker.addEventListener('statechange', () => {
                if (newWorker.state === 'installed' && navigator.serviceWorker.controller) {
                  console.log('Bitcoin Music SW updated');
        ...
        .catch((registrationError) => {
          console.log('Bitcoin Music SW registration failed: ', registrationError);
        });
